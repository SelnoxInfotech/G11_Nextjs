...
import  image1 from "./matchBackground.webp"
function Match({ updatematch, image }) {
    ...
    return (
        <div className={`container-fluid ${style.update_match}`}  >
            ...
            <ScrollContainer className={style.ScrollContainerRelative}  style={{    "justifyContent": "center"}}>
                {/* <div className=''> */}
                {
                                ...
                                <div className={` ${style.grid_row}`}>
                                    <Link href={`/cricket-match-predictions/${data.id}`} >
                                        ...
                                        <div className="col gap-3">
                                            <Image loader={imageLoader} src={`${data?.first_team_img}`} width={50} height={50} alt="G11-Fantasy " className='rounded-circle' style={{ width: "50px", height: '50px' }} />
                                            <span >VS</span>
                                            <Image loader={imageLoader} src={`${data?.second_team_img}`} width={50} height={50} alt="G11-Fantasy " className='rounded-circle' style={{ width: "50px", height: '50px' }} />
                                        </div>
                                        <div className="col">
