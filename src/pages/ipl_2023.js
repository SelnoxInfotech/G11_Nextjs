...
const Ipl2024 = ({initialData}) => { 
    ...
    return (
        <>
            <Seo
              Breadcrumlist={[{Home:"https://g11prediction.com/" } , {News: "/ipl_2023/"}]}
           ...
           ></Seo>
          <Card slug={'Ipl-2023'} props={fetchedData} heading={<h1>IPL 2023</h1>} query={"ipl-2023"}  data={null} data1={"ipl-2023"}></Card>
        </>
    );
};
