                ...
                <div className='row' >
                    <div className={`${'col-12'} ${style.box}`} style={{ background: false && "linear-gradient(180deg, rgba(255,255,255,1) 26%, rgba(194, 18, 28, 1) 228%)" }}>
                        <div className='col-11 mt-3 mx-auto' style={{ height: height ? "160px" : "100%", overflow: "hidden" }}>
                            ...
                            <p>{"Welcome to the G11 Prediction where cricket fans transcend from being mere spectators to strategic architects of their own fantasy cricket teams. At Fantasy Cricket Tips, were here to be your guide, your coach, and your cheerleader throughout your fantasy cricket journey."}</p>
