        ...
        <div className={`${'container'} ${style.aboutus}`}>
           ...
           ></Seo>
            ...
            <div className='container'>
                <div className='row '>
                    <div className='col-12 textSize '>
                        <p>
                            Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at g11hosting@gmail.com.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className='container'>
                <div className='row'>
                    <div className={`${'col-12'} ${style.hedding}`}>
                        <h2>In what situations and with which parties do we share personal information?</h2>
                    </div>
                ...
                <div className='row'>
                    ...
                    <div className='row '>
                        <div className='col-12 textSize '>
                            ...
                            <p>
                                If you have questions or comments about your privacy rights, you may email us at g11hosting@gmail.com.
                            </p>
                        </div>
            ...
            <div className='container '>
                <div className='row'>
                    ...
                    <div className='row '>
                        <div className='col-12 textSize '>
                            <p>
                                If you have questions or comments about this notice, you may email us at g11hosting@gmail.com or contact us by post at:
                            </p>
                            <p>
                                G11 Prediction
                                shop no 8,1st floor platinum plaza mata mandir road, bhopal (m.p)
            ...
            <div className='container '>
                <div className='row'>
                    ...
                    <div className='row '>
                        <div className='col-12 textSize '>
                            <p>
                                You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please contact us at g11hosting@gmail.com
                            </p>
                        </div>
